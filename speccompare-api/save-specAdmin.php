...
try {
    ...
    $is_ai = isset($data['is_ai']) ? (int)$data['is_ai'] : 0;
    ...
    $stmt = $conn->prepare("INSERT INTO saved_specs (user, spec_name, spec,recommendation, price, category, image_url, is_ai)
                            VALUES (:user, :spec_name, :spec,  :recommendation, :price, :category, :image_url, :is_ai)");

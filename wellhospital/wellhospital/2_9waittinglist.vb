...
Public Class waittinglistfrom
    ...
    Private Sub ButtonSearch_Click(sender As Object, e As EventArgs) Handles manageSeacrhbutt.Click
        ...
        ' สร้าง SQL Query ที่จะดึงข้อมูล Pt_ID, Pt_firstname, Pt_lastname, Pt_status, Ward_name โดยมีเงื่อนไขการค้นหา
        ' แสดงเฉพาะผู้ป่วยที่มีสถานะ Pt_status เป็น 'stay' หรือ 'wait'
        Dim query As String = "SELECT Patient.Pt_ID, 
                               ...
                               AND (Patient.Pt_status = 'stay' OR Patient.Pt_status = 'wait')"
